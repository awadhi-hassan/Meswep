            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-2">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="d-flex mt-3" style="justify-content: space-around">
                        <div class="card col-6 my-2 mr-3">
                            <div class="card-header" style="border-top-right-radius:8px; border-top-left-radius:8px;"></div>
                            <div class="card-body">                            
                                <img src="{{ asset('storage/media/commitee/cbot.png') }}" style="height: 120px; border-radius:10px; justify-content:end">
                                <p class="my-1" style="color: #0f893b"><strong> The Chair-Board of Trustees</strong></p>
                                <div>
                        ...
                        <div class="card col-6 my-2">
                            <div class="card-header" style="border-top-right-radius:8px; border-top-left-radius:8px"></div>
                            <div class="card-body">                            
                                <img src="{{ asset('storage/media/commitee/sbot.png') }}" style="height: 120px;  width:140px; border-radius:10px;">
                    ...
                    <div class="d-flex" style="justify-content: space-around">
                        <div class="card col-6 my-2 mr-3">
                            <div class="card-header" style="border-top-right-radius:8px; border-top-left-radius:8px"></div>
                            <div class="card-body">                            
                                <img src="{{ asset('storage/media/commitee/coordinator.png') }}" style="height: 140px; border-radius:10px;">
                        ...
                        <div class="card col-6 my-2">
                            <div class="card-header" style="border-top-right-radius:8px; border-top-left-radius:8px"></div>
                            <div class="card-body">                            
                                <img src="{{ asset('storage/media/commitee/chairman.png') }}" style="height: 140px; width: 130px; border-radius:10px;">
                    ...
                    <div class="d-flex" style="justify-content: space-around">
                        <div class="card col-6 mr-3 my-2">
                            <div class="card-header" style="border-top-right-radius:8px; border-top-left-radius:8px"></div>
                            <div class="card-body">                            
                                <img src="{{ asset('storage/media/commitee/secretary.png') }}" style="height: 140px; border-radius:10px;">
                        ...
                        <div class="card col-6 my-2">
                            <div class="card-header" style="border-top-right-radius:8px; border-top-left-radius:8px"></div>
                            <div class="card-body">                            
                                <img src="{{ asset('storage/media/commitee/assistant_secretary.png') }}" style="height: 140px; width: 130px; border-radius:10px;">
                    ...
                    <div class="d-flex">
                        <div class="card col-6 my-2">
                            <div class="card-header" style="border-top-right-radius:8px; border-top-left-radius:8px"></div>
                            <div class="card-body">                            
                                <img src="{{ asset('storage/media/commitee/treasurer.png') }}" style="height: 140px; border-radius:10px;">
